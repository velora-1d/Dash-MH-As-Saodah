...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 8rem; font-weight: 800; background: linear-gradient(135deg, #f43f5e, #e11d48); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1; }
        ...
        .bg-circle { position: fixed; border-radius: 50%; background: rgba(99, 102, 241, 0.08); }
...
<body>
    ...
    <div class="container">
        ...
        <p class="desc">Anda tidak memiliki izin untuk mengakses halaman ini. Hubungi administrator jika Anda merasa ini adalah kesalahan.</p>
