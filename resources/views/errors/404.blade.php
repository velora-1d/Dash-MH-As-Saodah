...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 8rem; font-weight: 800; background: linear-gradient(135deg, #f59e0b, #d97706); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1; }
        ...
        .bg-circle { position: fixed; border-radius: 50%; background: rgba(245, 158, 11, 0.08); }
...
<body>
    ...
    <div class="container">
        ...
        <p class="desc">Halaman yang Anda cari tidak ada atau telah dipindahkan. Pastikan URL yang Anda masukkan sudah benar.</p>
