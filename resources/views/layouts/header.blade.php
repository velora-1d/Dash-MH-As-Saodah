<header class="bg-white border-b border-gray-200 sticky top-0 z-30 shadow-sm shadow-gray-100/50">
        ...
        <div class="ml-4 flex items-center md:ml-6 space-x-4">
            ...
            <div class="flex items-center space-x-3">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex items-center px-4 py-2 text-sm font-bold text-red-600 hover:bg-red-50 rounded-xl transition-all border border-transparent hover:border-red-100">
