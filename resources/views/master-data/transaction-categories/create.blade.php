                ...
                <div style="padding: 2rem;">
                    <div class="fi-grid fi-grid-2">
                        <x-form-group label="Nama Kategori" name="name" :required="true">
                            <input type="text" name="name" id="name" required placeholder="Misal: Dana BOS, Listrik" value="{{ old('name') }}"
                        ...
                        <x-form-group label="Keterangan" name="description" hint="Opsional" class="fi-grid-full">
                            <textarea name="description" id="description" rows="2" placeholder="Penjelasan singkat"
