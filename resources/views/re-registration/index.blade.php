        ...
        <div style="background: #fff; border-radius: 1rem; border: 1px solid #e2e8f0; overflow: hidden;">
            <div onclick="document.getElementById('rereg-settings-body').style.display = document.getElementById('rereg-settings-body').style.display === 'none' ? 'block' : 'none'; this.querySelector('.chevron').style.transform = document.getElementById('rereg-settings-body').style.display === 'none' ? '' : 'rotate(180deg)'" style="padding: 1rem 1.5rem; display: flex; align-items: center; justify-content: space-between; cursor: pointer; background: linear-gradient(180deg, #f8fafc 0%, #fff 100%); border-bottom: 1px solid #f1f5f9;">
                <div style="display: flex; align-items: center; gap: 0.5rem;">
                    ...
                    <div>
                        <h4 style="font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 0.8125rem; color: #1e293b; margin: 0;">Pengaturan & Rekap Daftar Ulang</h4>
                        <p style="font-size: 0.6875rem; color: #94a3b8; margin: 0;">Atur nominal biaya dan lihat rekap penerimaan kas</p>
                    </div>
                </div>
            ...
            <div id="rereg-settings-body" style="display: none; padding: 1.5rem;">
                <!-- Nominal -->
                ...
                <div style="display: flex; justify-content: flex-end; margin-bottom: 1.25rem;">
                    <button onclick="saveReRegSettings()" style="display: inline-flex; align-items: center; gap: 0.375rem; padding: 0.5rem 1.25rem; background: linear-gradient(135deg, #8b5cf6, #7c3aed); color: #fff; border: none; border-radius: 0.5rem; font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 0.75rem; cursor: pointer; box-shadow: 0 2px 8px rgba(139,92,246,0.3); transition: all 0.2s ease;" onmouseover="this.style.transform='translateY(-1px)'" onmouseout="this.style.transform=''">
                ...
                <div style="border-top: 1.5px solid #f1f5f9; padding-top: 1.25rem;">
                    <p style="font-size: 0.6875rem; font-weight: 700; color: #64748b; text-transform: uppercase; letter-spacing: 0.06em; margin: 0 0 0.75rem; display: flex; align-items: center; gap: 0.25rem;"><svg style="width:13px;height:13px;flex-shrink:0;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg> Rekap Penerimaan Kas Daftar Ulang</p>
                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0.75rem;">
                        <div style="background: linear-gradient(135deg, #f5f3ff, #ede9fe); border: 1px solid #c4b5fd; padding: 0.875rem; border-radius: 0.75rem; text-align: center;">
                            <p style="font-size: 0.625rem; font-weight: 600; color: #7c3aed; margin: 0;">Daftar Ulang</p>
                            <p style="font-family: 'Outfit', sans-serif; font-weight: 800; font-size: 1rem; color: #5b21b6; margin: 0.25rem 0 0;">Rp {{ number_format($paymentStats['total_fee'], 0, ',', '.') }}</p>
