                ...
                <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1rem;">
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        ...
                        <div>
                            ...
                            <p style="font-size: 0.8125rem; color: rgba(255,255,255,0.7); margin-top: 0.125rem;">Tambahkan item navigasi baru ke dalam sidebar aplikasi.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style="padding: 2rem; display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div style="grid-column: span 2;">
                        ...
                        <textarea name="icon_svg" rows="3" required placeholder="Contoh: <path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M3 12l2-2m0 0l7-7 7 7M5...' />"
                                  ...
                                  onfocus="this.style.borderColor='#6366f1'" onblur="this.style.borderColor='#e2e8f0'">{{ old('icon_svg') }}</textarea>
                    </div>
