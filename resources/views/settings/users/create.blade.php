            ...
            <form action="{{ route('settings.users.store') }}" method="POST">
                ...
                <div style="padding: 2rem; display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                    ...
                    <div>
                        ...
                        <select name="role" required style="width: 100%; padding: 0.625rem 0.875rem; border: 1px solid #e2e8f0; border-radius: 0.625rem; font-size: 0.8125rem; outline: none;">
                    ...
                    <div>
                        <label style="display: block; font-size: 0.8125rem; font-weight: 600; color: #374151; margin-bottom: 0.5rem;">Password <span style="color: #e11d48;">*</span></label>
                    ...
                    <div>
                        <label style="display: block; font-size: 0.8125rem; font-weight: 600; color: #374151; margin-bottom: 0.5rem;">Konfirmasi Password <span style="color: #e11d48;">*</span></label>
                        <div style="position: relative;">
