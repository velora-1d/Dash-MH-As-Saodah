                ...
                <div style="padding: 2rem;">
                    <div class="fi-grid fi-grid-2">
                        ...
                        <x-form-group label="Role Otoritas" name="role" :required="true">
                            <select name="role" required class="fi-input fi-select @error('role') fi-error @enderror" {{ $user->id === Auth::id() ? 'disabled' : '' }}>
                        ...
                        <x-form-group label="Konfirmasi Password Baru" name="password_confirmation">
                            <div style="position: relative;">
                                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Tulis ulang jika diisi"
